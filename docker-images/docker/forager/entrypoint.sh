...
supervisorctl start promtail
supervisorctl start node_exporter
supervisorctl start hg_heartbeat
supervisorctl start hg_session
sleep 30 
supervisorctl start hg_odds
supervisorctl start hg_minmax
supervisorctl start hg_bet 
supervisorctl start hg_balance
supervisorctl start hg_orders
supervisorctl start hg_settlement
